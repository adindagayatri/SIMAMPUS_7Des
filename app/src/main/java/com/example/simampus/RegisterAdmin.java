        ...
        btnSignup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(tPassword.equals(tPassword)){
                    ...
                    if(val > 0){
                        Toast.makeText(com.example.simampus.RegisterAdmin.this,"Register Success !",Toast.LENGTH_SHORT).show();
                        Intent moveToLogin = new Intent(com.example.simampus.RegisterAdmin.this,LoginAdmin.class);
                        startActivity(moveToLogin);
                    } else{
                        Toast.makeText(com.example.simampus.RegisterAdmin.this,"Register Error !",Toast.LENGTH_SHORT).show();
                    }
                }else{
                    Toast.makeText(com.example.simampus.RegisterAdmin.this,"Wrong Password !",Toast.LENGTH_SHORT).show();
                }
            }
        });
