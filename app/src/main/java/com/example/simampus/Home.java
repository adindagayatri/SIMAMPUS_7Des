...
public class Home extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                startActivity(new Intent(com.example.simampus.Home.this, AddActivity.class));
            }
        });
    ...
    public void onItemClick(AdapterView<?> parent, View view, int i, long x) {
        ...
        final AlertDialog.Builder builder = new AlertDialog.Builder(com.example.simampus.Home.this);
        ...
        builder.setItems(options, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which){
                    case 0:
                        final AlertDialog.Builder viewData = new AlertDialog.Builder(com.example.simampus.Home.this);
                ...
                switch (which){
                    case 1:
                        Intent iddata = new Intent(com.example.simampus.Home.this, EditActivity.class);
                        iddata.putExtra(DBHelperBuku.COLUMN_4, id);
                        startActivity(iddata);
                }
                switch (which){
                    case 2:
                        AlertDialog.Builder builder1 = new AlertDialog.Builder(com.example.simampus.Home.this);
                        ...
                        builder1.setPositiveButton("Hapus", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                ...
                                Toast.makeText(com.example.simampus.Home.this, "Data Buku Berhasil Di Hapus !", Toast.LENGTH_SHORT).show();
                                setListView();
                            }
                        });
